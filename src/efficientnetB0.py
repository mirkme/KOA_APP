...
from tensorflow.keras.applications.efficientnet import EfficientNetB0, preprocess_input  # ✅ FIXED

np.random.seed(12049)

# --- Add Paths Here ---
OUTPUT_DIR = "C:\\Users\\Loq\\Desktop\\C_output"  
...
# Load data
augmented_base_dir = "C:\\Users\\Loq\Desktop\\augmented output-20250307T164047Z-001\\augmented output"

train_path = os.path.join(augmented_base_dir, 'train')
valid_path = os.path.join(augmented_base_dir, 'val')
test_path = os.path.join(augmented_base_dir, 'test')
...
get_plot_loss_acc(model_ft, model_name)
get_evaluate(valid_generator, "Validation", model_ft, class_names)
y_pred_val = get_predict(valid_generator, model_ft)
get_metrics(y_val, np.argmax(y_pred_val, axis=1), model_name)
compute_confusion_matrix(valid_generator, y_pred_val, class_names, model_name)
